                    ...
                    <?php foreach ($laborat as $l) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/admin/editlaborat/<?= $l['ID_LABORAT']; ?>" class=" text-decoration-none fas fa-edit btn-sm btn-warning"></a>
                                <!-- Form Hapus -->
                                <form action="/admin/deletelaborat/<?= $l['ID_LABORAT']; ?>" method="post" class="d-inline">
                                    <?= csrf_field(); ?>
