...
<div class="card shadow mb-4 col-sm-12">
    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
        <a href="/admin/indexmasterlab" class=" mb-auto text-decoration-none fas fa-arrow-circle-left btn-light btn-primary btn-sm mt-xl-3"> back</a>
    </div>
    <div class="card-body">
        <p class="card-text">
        <h2 class="my-3">Form Ubah Data Master Laboratorium</h2>
        <form action="/admin/updatemasterlab/<?= $masterlab['ID_MASTERLAB']; ?>" method="POST">
            <?= csrf_field(); ?>
