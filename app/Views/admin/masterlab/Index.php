                ...
                <tbody>
                    ...
                    <?php foreach ($masterlab as $ml) : ?>
                        <tr>
                            ...
                            <!-- Form Edit -->
                            <td>
                                <a href="/admin/editmasterlab/<?= $ml['ID_MASTERLAB']; ?>" class=" text-decoration-none fas fa-edit btn-sm btn-warning"></a>
                                <form action=" /admin/deletemasterlab/<?= $ml['ID_MASTERLAB']; ?>" method="post" class="d-inline">
                                    <?= csrf_field(); ?>
