...
<div class="card shadow mb-4 col-sm-12">
    ...
    <div class="card-body">
        ...
        <form action="savepasienadmin" method="POST">
            <?= csrf_field(); ?>
            <div class="row mb-3">
                <label for="NAMA_PASIEN" class="col-sm-2 col-form-label">Nama Pasien</label>
                <div class="col-sm-10">
                    <input onkeyup="this.value = this.value.toUpperCase()" type="text" class="form-control <?= ($validation->hasError('NAMA_PASIEN')) ? 'is-invalid' : ''; ?>" id="NAMA_PASIEN" name="NAMA_PASIEN" autofocus value="<?= old('NAMA_PASIEN'); ?>">
