...
<div class="card shadow mb-4 col-sm-12">
    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
        <a href="/admin/indexpasien" class=" mb-auto text-decoration-none fas fa-arrow-circle-left btn-light btn-primary btn-sm mt-xl-3"> back</a>
    </div>
    <div class="card-body">
        <p class="card-text">
        <h2 class="my-3">Form Ubah Data Pasien</h2>
        <form action="/admin/updatepasien/<?= $pasien['ID_PASIEN']; ?>" method="POST">
            <?= csrf_field(); ?>
            <div class="row mb-3">
                <label for="NAMA_PASIEN" class="col-sm-2 col-form-label">Nama Pasien</label>
                <div class="col-sm-10">
                    <input onkeyup="this.value = this.value.toUpperCase()" type="text" class="form-control <?= ($validation->hasError('NAMA_PASIEN')) ? 'is-invalid' : ''; ?>" id="NAMA_PASIEN" name="NAMA_PASIEN" autofocus value="<?= (old('NAMA_PASIEN')) ? old('NAMA_PASIEN') : $pasien['NAMA_PASIEN']; ?>">
