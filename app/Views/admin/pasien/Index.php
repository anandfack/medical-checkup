                    ...
                    <?php foreach ($pasien as $p) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/admin/editpasien/<?= $p['ID_PASIEN']; ?>" class=" text-decoration-none fas fa-edit btn-sm btn-warning"></a>
                                <form action="/admin/deletepasien/<?= $p['ID_PASIEN']; ?>" method="post" class="d-inline">
                                    <?= csrf_field(); ?>
