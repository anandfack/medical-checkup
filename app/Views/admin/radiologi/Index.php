                ...
                <tbody>
                    ...
                    <?php foreach ($radiologi as $r) : ?>
                        <tr>
                            ...
                            <!-- Form Edit -->
                            <td>
                                <a href="/admin/editradiologi/<?= $r['ID_RADIOLOGI']; ?>" class=" text-decoration-none fas fa-edit btn-sm btn-warning"></a>
                                <form action="/admin/deleteradiologi/<?= $r['ID_RADIOLOGI']; ?>" method="post" class="d-inline">
                                    <?= csrf_field(); ?>
