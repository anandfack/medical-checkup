...
<div class="card shadow mb-4 col-sm-12">
    ...
    <div class="card-body">
        <div class="card-title">
            <a href="laborat/create" class="btn btn-primary mt-3">Tambah Data</a>
        </div><br>
                    ...
                    <?php foreach ($laborat as $l) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/laborat/edit/<?= $l['ID_LABORAT']; ?>" class="btn btn-warning">Ubah</a>
                                <!-- Form Hapus -->
                                <form action="/laborat/delete/<?= $l['ID_LABORAT']; ?>" method="post" class="d-inline">
                                    <?= csrf_field(); ?>
