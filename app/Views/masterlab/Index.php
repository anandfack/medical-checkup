...
<div class="card shadow mb-4 col-sm-12">
    ...
    <div class="card-body">
        <div class="card-title">
            <a href="masterlab/create" class="btn btn-primary mt-3">Tambah Data</a>
        </div><br>
                ...
                <tbody>
                    ...
                    <?php foreach ($masterlab as $ml) : ?>
                        <tr>
                            ...
                            <!-- Form Edit -->
                            <td>
                                <a href="/masterlab/edit/<?= $ml['ID_MASTERLAB']; ?>" class="btn btn-warning">Ubah</a>
                                <form action="/masterlab/delete/<?= $ml['ID_MASTERLAB']; ?>" method="post" class="d-inline">
                                    <?= csrf_field(); ?>
