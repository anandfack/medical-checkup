                ...
                <tbody>
                    ...
                    <?php foreach ($Kesimpulan  as $ke) : ?>
                        <tr>
                            ...
                            <!-- Form Detail -->
                            <td>
                                <a href="/pasien/detailkesimpulan/<?= $ke['ID_KESIMPULAN']; ?>" class=" text-decoration-none fas fa-eye btn-sm btn-success"></a>
                                <a href="/pasien/editkesimpulan/<?= $ke['ID_KESIMPULAN']; ?>" class=" text-decoration-none fas fa-edit btn-sm btn-warning"></a>
                                <form action="/pasien/deletekesimpulan/<?= $ke['ID_KESIMPULAN']; ?>" method="post" class="d-inline">
                                    <?= csrf_field(); ?>
