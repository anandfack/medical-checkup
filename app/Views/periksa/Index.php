...
<div class="card shadow mb-4 col-sm-12">
    ...
    <div class="card-body">
        <div class="card-title">
            <a href="periksa/create" class="btn btn-primary mt-3">Tambah Data</a>
        </div><br>
                ...
                <tbody>
                    ...
                    <?php foreach ($Periksa  as $pe) : ?>
                        <tr>
                            ...
                            <!-- Form Detail -->
                            <td>
                                <a href="/periksa/detailperiksa/<?= $pe['ID_PERIKSA']; ?>" class="btn btn-success">Detail</a>
                                <a href="/periksa/edit/<?= $pe['ID_PERIKSA']; ?>" class="btn btn-warning">Ubah</a>
                                <form action="/periksa/delete/<?= $pe['ID_PERIKSA']; ?>" method="post" class="d-inline">
                                    <?= csrf_field(); ?>
