...
<div class="card shadow mb-4 col-sm-12">
    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
        <a href="/radiologi/indexradiologi" class=" mb-auto text-decoration-none fas fa-arrow-circle-left btn-light btn-primary btn-sm mt-xl-3"> back</a>
    </div>
    <div class="card-body">
        <p class="card-text">
        <h2 class="my-3">Form Ubah Data Radiologi</h2>
        <form action="/radiologi/updateradiologi/<?= $radiologi['ID_RADIOLOGI']; ?>" method="POST">
            <?= csrf_field(); ?>
            <div class="row mb-3">
