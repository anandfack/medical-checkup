                ...
                <tbody>
                    ...
                    <?php foreach ($masterrad as $mr) : ?>
                        <tr>
                            ...
                            <!-- Form Edit -->
                            <td>
                                <a href="/radiologi/editmasterrad/<?= $mr['ID_MASTERRAD']; ?>" class=" text-decoration-none fas fa-edit btn-sm btn-warning"></a>
                                <form action="/radiologi/deletemasterrad/<?= $mr['ID_MASTERRAD']; ?>" method="post" class="d-inline">
                                    <?= csrf_field(); ?>
