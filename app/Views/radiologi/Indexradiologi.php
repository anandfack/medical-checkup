...
<div class="card shadow mb-auto col-sm-12">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Tabel Radiologi</h6>
    </div>
    <div class="card-body">
        <div class="card-title">
            <a href="createradiologi" class=" text-decoration-none fas fa-plus-circle btn-sm btn-primary"> Tambah Data</a>
        </div>
                ...
                <tbody>
                    ...
                    <?php foreach ($radiologi as $r) : ?>
                        <tr>
                            ...
                            <!-- Form Edit -->
                            <td>
                                <a href="/radiologi/editradiologi/<?= $r['ID_RADIOLOGI']; ?>" class=" text-decoration-none fas fa-edit btn-sm btn-warning"></a>
                                <form action="/radiologi/deleteradiologi/<?= $r['ID_RADIOLOGI']; ?>" method="post" class="d-inline">
                                    <?= csrf_field(); ?>
